...
function print_help(msg, config) {
  const cmd_message = ''
    ...
    + 'Challenger\n'
    + '--------------------\n'
    + '- launch challenge: `' + config.COMMANDS_PHRASES.challenge_phrase + '` ou `' + config.PREFIX + ' fight`\n'
    + '- resign challenge: `' + config.COMMANDS_PHRASES.resign_phrase + '` ou `' + config.PREFIX + ' resign`\n'
    + '-'.repeat(2 * config.DREADNOUGHT_NAME.length) + '\n'
    + config.DREADNOUGHT_NAME + '\n'
    + '-'.repeat(2 * config.DREADNOUGHT_NAME.length) + '\n'
    + '- win challenge: `' + config.COMMANDS_PHRASES.dreadnought_win_phrase + '` ou `' + config.PREFIX + ' resign` + <mention du perdant>\n'
    + '- lose challenge: `' + config.COMMANDS_PHRASES.dreadnought_lose_phrase + '` ou `' + config.PREFIX + ' lose`\n'
